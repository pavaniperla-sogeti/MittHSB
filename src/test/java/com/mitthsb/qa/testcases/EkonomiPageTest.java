...
public class EkonomiPageTest extends TestBase {
	...
	@Test(groups = "Regression",description="Verify that saldo Rapport Genvagar is displayed or not")//to see whether shortcut is displayed or not
	...
	@Test(groups = "Regression",description="Verify that Saldo Genvagar link is redirecting ot the right page")//to see whether shortcut is properly redirecting to iframe or not
	...
	@Test(groups = "Regression",description="Verify that DigitalWebFakturor button is redirecting to the right page")//to see digitalwebfaktura button in allFakturor list item is properly redirecting to external webpage
	public void clickDigitalWebFakturaButtonTest() {
		...
		TestUtil.closeActiveTabSwitchToHomeTab();
		softAssert.assertAll();
	}
	
	
	@Test(groups = "Regression",description="Verify that likvida Medel graph is displayed or not")
	...
	@Test(groups = "Regression",description="Verify that Disponible graph is displayed or not")
	...
	@Test(groups = "Regression",description="Verify that CashFlow graph is displayed or not")
	...
	@Test(groups = "Regression",description="Verify that Ekonomi graph is displayed or not")
	...
	@Test(groups = "Regression",description="Verify the display of 5 genvagars in ekonomi page")
	...
	@Test(groups = "Regression",description="Verify whether click on any Genvagar is redirecting to the right rapport page")
	...
	@Test(groups = "Regression",description="Verify the list item FinansiellaRapport is redirecting to proper page or not")
	...
	@Test(groups = "Regression",description="Verify the list item AllaFakturor is redirecting to proper page or not")
	...
	@Test(groups = "Regression",description="Verify the information icon on LikvidaMedel graph is showing the right informatio ")
	...
	@Test(groups = "Regression",description="Verify the information icon on RapportGenvagar graph is showing the right informatio ")
	...
	@Test(groups = "Regression",description="Verify the information icon on DisponiBelt graph is showing the right informatio ")
	...
	@Test(groups = "Regression",description="Verify the information icon on Cashflow graph is showing the right information")
