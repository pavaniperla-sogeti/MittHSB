//this is to customize the index.html default report to include screenshots (report generated would be emailable-report2.html)
...
public class TestNGEmailableReport2 implements IReporter {
  ...
  //  @Override
    ...
    protected void writeReportTitle(String title) {
		writer.println("<center><h1>" + title + " - " + TestUtil.getCurrentDateTime() + "</h1></center>");
	}
